   ...
   // [Authorize(Roles = "Admin,SuperAdmin")]
    ...
    public class TourController : Controller
    {
        ...
        public IActionResult Delete(int? id)
        {
            ...
            exist.PictureUrl.DeleteFile(_env.WebRootPath, "assets/images/tour");
        ...
        {
            var picture = ctour.Picture;
            var result1 = picture?.CheckValidate("image/", 20000);
            if (result1?.Length > 0)
            {
            ...
            Tour tour = new Tour
            {
                ...
                Location = ctour.Location,
                CountryId = ctour.CountryId,
                PictureUrl = picture.SaveFile(Path.Combine(_env.WebRootPath, "assets", "images","tour"))
            };
        ...
        public IActionResult Update(int? id, UpdateTourVM update)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                ViewBag.TCategories = new SelectList(_context.TCategories, nameof(TCategory.Id), nameof(TCategory.Name));
                ViewBag.Countries = new SelectList(_context.Countries.ToList(), nameof(Country.Id), nameof(Country.Name));
                ViewBag.Video = _context.Tours.FirstOrDefault(t => t.Id == id).PictureUrl;
                return View();
            }
            ...
            if (picture != null)
            {
                string newVideo = picture.SaveFile(Path.Combine(_env.WebRootPath, "assets", "images","tour"));
                tour.PictureUrl.DeleteFile(_env.WebRootPath, "assets/images/tour");
                tour.PictureUrl = newVideo;
            }
